...
interface SovendusEmployeeBenefitsProps {
  ...
  featureFlags: SovendusEmployeeBenefitsFeatureFlags;
}

interface SovendusEmployeeBenefitsFeatureFlags {
            ...
            >
              ...
              >
                ...
                <div className={cn("tw:flex tw:flex-col tw:space-y-2")}>
                  <div
                    className={cn("tw:flex tw:items-center tw:justify-between")}
                  >
                    <Label
